...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* --- SCROLLBAR CUSTOM --- */
        .main-content::-webkit-scrollbar, .sidebar-nav::-webkit-scrollbar, .table-responsive::-webkit-scrollbar {
            width: 6px; height: 6px;
        }
        .main-content::-webkit-scrollbar-track, .sidebar-nav::-webkit-scrollbar-track {
            background: transparent;
        }
        .main-content::-webkit-scrollbar-thumb, .sidebar-nav::-webkit-scrollbar-thumb {
        ...
        .sidebar-group summary:hover { background-color: rgba(255, 255, 255, 0.1); color: white; }
        .sidebar-group summary::-webkit-details-marker { display: none; }
        
        /* Icon Panah */
        .sidebar-group summary i.bi-chevron-down {
            margin-left: auto; font-size: 0.8rem; transition: transform 0.3s;
        }
        .sidebar-group[open] summary i.bi-chevron-down { transform: rotate(180deg); }

        /* Link Sub-menu (Anak) */
        .sidebar-group a {
            padding: 0.6rem 1.5rem 0.6rem 3.5rem !important; /* Indentasi ke dalam */
            font-size: 0.9rem;
            display: flex;
        ...
        .hamburger-menu {
            ...
            padding: 8px; background: var(--bg-gray); border-radius: 8px; transition: all 0.2s;
        }
        .hamburger-menu:hover { background: var(--light-blue); }
        .hamburger-menu span {
            width: 24px; height: 3px; background: var(--primary-blue);
        ...
        .search-box input {
            ...
            border: 1px solid #e5e7eb; border-radius: 10px; font-size: 0.9rem; transition: all 0.2s;
        }
        ...
        .search-box i {
            position: absolute; left: 1rem; top: 50%; transform: translateY(-50%); color: #9ca3af;
        }

        .user-info { display: flex; align-items: center; gap: 1rem; }
        .notification-icon {
            position: relative; width: 40px; height: 40px; background: var(--bg-gray);
            border-radius: 10px; display: flex; align-items: center; justify-content: center;
            cursor: pointer; transition: all 0.2s;
        }
        .notification-icon:hover { background: var(--light-blue); }
        .notification-badge {
            position: absolute; top: 8px; right: 8px; width: 8px; height: 8px;
            background: #ef4444; border-radius: 50%;
        }
        
        .user-avatar { display: flex; align-items: center; gap: 0.75rem; cursor: pointer; }
        ...
        .page-header h2 { font-size: 1.75rem; font-weight: 700; color: #015255ff; margin-bottom: 0.25rem; }
        .page-header .date { color: #6b7280; font-size: 0.9rem; }
        ...
        .stat-label { color: #6b7280; font-size: 0.85rem; font-weight: 500; margin-bottom: 0.5rem; }
        .stat-value { font-size: 2rem; font-weight: 700; color: #015255ff; margin-bottom: 0.5rem; }
        ...
        .chart-card { background: white; border-radius: 16px; padding: 1.5rem; box-shadow: var(--card-shadow); }
        .chart-card.full-width { grid-column: 1 / -1; }
        .chart-header { display: flex; justify-content: space-between; align-items: center; margin-bottom: 1.5rem; }
        .chart-title { font-size: 1.1rem; font-weight: 600; color: #015255ff; display: flex; align-items: center; gap: 0.5rem; }
        .chart-canvas { position: relative; height: 300px; }

        .table-card { background: white; border-radius: 16px; padding: 1.5rem; box-shadow: var(--card-shadow); margin-bottom: 1.5rem; }
        .table-responsive { max-height: 500px; overflow-y: auto; border-radius: 10px; }
        .modern-table { width: 100%; font-size: 0.9rem; border-collapse: collapse; }
        .modern-table thead { background: var(--bg-gray); position: sticky; top: 0; z-index: 10; }
        .modern-table th { padding: 1rem; font-weight: 600; color: #4b5563; border: none; text-align: left; }
        .modern-table td { padding: 1rem; border-bottom: 1px solid #f3f4f6; color: #015255ff; }
        .modern-table tbody tr { transition: all 0.2s; }
        .modern-table tbody tr:hover { background: var(--bg-gray); }
        ...
        @media (max-width: 768px) {
            .sidebar { position: fixed; top: 0; left: 0; bottom: 0; transform: translateX(-100%); z-index: 1001; }
            .sidebar.active { transform: translateX(0); }
            .hamburger-menu { display: flex; }
            .top-navbar { padding: 0.75rem 1rem; gap: 0.5rem; }
            .search-box { display: none; }
            .user-info { gap: 0.5rem; margin-left: auto; }
            .user-avatar span { display: none; }
            .user-info form { margin-left: 0 !important; }
            .user-info .btn { padding: 0.4rem 0.6rem; font-size: 0.85rem; }
            .content-area { padding: 1rem; }
            .page-header h2 { font-size: 1.4rem; }
            .notification-icon { width: 36px; height: 36px; }
            .user-avatar .avatar-placeholder { width: 36px; height: 36px; font-size: 0.85rem; }
        ...
        @media (max-width: 480px) {
            ...
            .user-avatar .avatar-placeholder { width: 32px; height: 32px; font-size: 0.8rem; }
            .user-info .btn { padding: 0.35rem 0.5rem; font-size: 0.8rem; }
            .user-info .btn span { display: none; }
        }
    </style>
</head>
<body>
